...
export default function page() {
  return (
    <main className="flex w-full flex-col items-center pb-[5rem]">
      <div className="relative flex h-[35rem] w-full items-center justify-center lg:h-[50rem]">
        <Image src="/images/bgs/about-us/about-us-bg.webp" className="bg-center object-cover" fill alt="about-us-bg" />
        ...
        <div className="absolute bottom-[-2rem] z-[6] flex h-[6rem] w-[20rem] items-center justify-center rounded-[.5rem] bg-green-800 py-[1rem] shadow-lg">
          <h4 className="z-[10] text-[3rem] font-bold tracking-wider text-white drop-shadow-lg">About Us</h4>
        </div>
      </div>
      <AboutText />
      <Charities />

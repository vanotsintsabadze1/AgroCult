...
export default function CompanyVerificationCard() {
  return (
    <div className="w-full py-[3rem] bg-primary flex flex-col items-center dark:bg-dark-secondary justify-center gap-[2rem] lg:flex-row-reverse lg:py-[4rem] lg:gap-x-[8rem]">

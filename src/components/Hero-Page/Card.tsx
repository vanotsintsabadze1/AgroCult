  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-[1rem]">
        <h4 className="mt-[1rem] bg-gradient-to-r from-green-500 to-orange-300 bg-clip-text text-[8rem] font-bold tracking-wider text-transparent drop-shadow-text-heavy lg:text-[15rem] xs:text-[7rem]">
          AgroCult
        </h4>
        <p className="w-[35rem] text-center text-[1.4rem] font-medium text-white drop-shadow-text-heavy lg:w-[60rem] lg:text-[1.5rem] xs:w-[30rem]">
          {word("phrase")}
        </p>

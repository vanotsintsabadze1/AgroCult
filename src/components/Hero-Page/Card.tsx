  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-[1rem]">
        <h4 className="mt-[1rem] bg-gradient-to-r from-green-500 to-orange-300 bg-clip-text text-[8rem] font-bold tracking-wider text-transparent drop-shadow-text-heavy lg:text-[15rem] xs:text-[6rem]">
          AgroCult
        </h4>

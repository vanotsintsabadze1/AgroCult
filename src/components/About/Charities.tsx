...
export default async function Charities() {
  ...
  return (
    <FadeWrapper delay={0} duration={700} direction="up">
      <div className="mt-[4rem] flex flex-col items-center gap-[2rem] text-center dark:text-white">
        ...
        <div className="mt-[4rem] flex flex-col items-center gap-x-[5rem] lg:flex-row-reverse lg:items-start">
          <div className="flex flex-col items-center gap-[2rem]">
            <p className="max-w-[35rem] text-[1.5rem] lg:max-w-[70rem] lg:text-left xs:w-[30rem]">
          ...
          <div className="relative h-[25rem] w-[35rem] shadow-2xl lg:h-[30rem] lg:w-[45rem]">
            <Image src="/images/showout-images/about-us-second.webp" className="rounded-[.8rem]" alt="test" fill />
          </div>
        </div>
      </div>
    </FadeWrapper>

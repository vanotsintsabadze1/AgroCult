        ...
        <div key={payment.id} className="grid w-[100rem] grid-cols-6 bg-white px-[1rem] py-[1.5rem] text-black">
          ...
          <div className="col-span-1 m-auto text-[1.5rem]">
            {payment.status === "succeeded" ? (
              <div className="border-2 border-green-500 px-[1rem] py-[.5rem] text-[1.2rem] font-bold uppercase text-green-600">
                {payment.status}
              </div>
            ) : (
              <div className="border-2 border-red-500 px-[1rem] py-[.5rem] text-[1.2rem] font-bold uppercase text-red-500">
                {payment.status}
              </div>
            )}
          </div>

...
function Profile() {
  ...
  return (
    <main className="flex h-[75rem] w-full items-center justify-center p-[2rem] lg:h-[80rem]">
      <div className="w-full min-h-[65rem] shadow-soft rounded-[1rem] flex flex-col items-center p-[2rem] lg:w-[80rem] md:w-[65rem] sm:w-[40rem]">
        <section className="w-full flex justify-center items-center p-[1rem] flex-col gap-[2rem] mt-[2rem]">
          ...
          <h2 className="font-bold text-[2rem]">Edit Your Profile</h2>
        </section>

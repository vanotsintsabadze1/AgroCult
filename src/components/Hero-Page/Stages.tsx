      ...
      <section className="flex w-full flex-col items-center justify-center gap-y-[4rem] px-[2rem] py-[2rem] lg:gap-y-[8rem]">
        <FadeWrapper direction="up" delay={0} duration={1000}>
          {stages.map((stage, index) => (
            ...
            >
              <div className="relative h-[28rem] w-[36rem] md:h-[35rem] md:w-[45rem] xl:h-[40rem] xl:w-[55rem] xs:h-[25rem] xs:w-[32rem]">
                <Image
                  src={stage.imageUrl}
                  alt={`pic-${index}`}
                  fill
              ...
              <div className="pl-[1rem] xs:pl-0 dark:text-white">
                <h4 className="mt-[1.5rem] break-words text-[3rem] font-bold text-green-800 drop-shadow-lg sm:w-[40rem] lg:mt-0 xs:w-full dark:text-green-600">
                  {stage.title}
                </h4>
